    ...
    stages {
        ...
        stage('deploy in tomcat') {
            steps {
                ...
                deploy adapters: [tomcat9(alternativeDeploymentContext: '', credentialsId: 'tomcat', path: '', url: 'http://ec2-34-233-124-6.compute-1.amazonaws.com:8080/')], contextPath: 'brandnew', war: '**/*.war'
            }
        }        
    }
}
